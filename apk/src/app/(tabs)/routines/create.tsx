    ...
    try {
      ...
      await Promise.all(
        selectedDays.map((day) =>
          createRoutineDay({
            rutinaLocalId: routine.local_id,
            diaSemana: day,
          }),
        ),
      );
      ...
      setError(createError instanceof Error ? createError.message : 'No se pudo guardar la rutina.');
    } finally {
      setSubmitting(false);
    }
  }
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerTitleBlock}>
              <View style={styles.headerTitleRow}>
                ...
                <ThemedText style={styles.headerTitle}>Define tu Rutina</ThemedText>
              </View>

              <ThemedText themeColor="textSecondary" style={styles.headerSubtitle}>
                Crea un nombre claro para tu rutina
              </ThemedText>
            </View>
